...
import { Package, ShoppingCart, Users, TrendingUp, BarChart3, Settings, AlertTriangle, CheckCircle } from "lucide-react"
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Vue d'ensemble complète de votre système de gestion des stocks et des opérations.</p>
            </div>
